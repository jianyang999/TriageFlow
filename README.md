...
# About
TriageFlow is a prototype hospital management web app built for NUS orbital. It is meant to streamline patient queues, medicine ordering and more. 
...
- Medicine ordering and dispensing
- Patient records
